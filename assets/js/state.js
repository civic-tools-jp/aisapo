...
let records=[], contacts=[], branches=[], areas=[], users=[], map, markers={}, editing=null, editingContact=null, editStatus="unvisited", currentAreaId=localStorage.getItem("aisapo_area")||"", branchMessages=[];
